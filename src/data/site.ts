...
export const trainingCards = [
  { title: "BLS", href: "/bls/", eyebrow: "Reanimatie en AED", description: "Leer volwassenen reanimeren en een AED veilig inzetten volgens de richtlijnen van de Nederlandse Reanimatie Raad." },
  { title: "PBLS", href: "/pbls/", eyebrow: "Kinderen en baby's", description: "Praktische training voor hulpverlening aan kinderen en baby's, met aandacht voor handelen onder druk." },
  { title: "Instructeursopleidingen", href: "/instructeursopleidingen/", eyebrow: "NRR en didactiek", description: "Word BLS- of PBLS-instructeur en ontwikkel naast technische vaardigheden ook je didactische kracht." },
  { title: "Waterveiligheid", href: "/waterveiligheid/", eyebrow: "Zwembadbranche", description: "Trainingen voor zwembadmedewerkers en professionals die verdrinkingsongevallen willen voorkomen." }
];
